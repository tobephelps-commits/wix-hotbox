...
/**
 * Per-warehouse quantity breakdown for inventory snapshots.
 * Lightweight shape used by getWarehouseBreakdown().
 */
 ...
 * format. Filters out warehouses with zero quantity to keep data concise.
 *
 * @param skuInventory - Single SKU inventory with warehouse breakdown
