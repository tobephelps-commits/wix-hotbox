 ...
 *
 * Usage:
 *   import { sanmarAdapter } from './scripts/sanmar/adapter.js';
 *   const products = await sanmarAdapter.getProductsByStyle('PC61');
 *
 * CLI verification:
 *   npx tsx scripts/sanmar/adapter.ts [STYLE]
 *
 * Phase 17: S&S Activewear API Integration (Plan 03)
 */
